...
function updateHeaderLanguage(newLanguage)
{
    ...
    if ( newLanguage === "en" )
    {
        ...
        "Development of the catalogue map is ongoing, and our priority is to improve it to fit your needs. As such, your feedback is very important to us. Click below to reach our Feedback Form.<br><br>" +
    ...
    else
    {
        ...
        "L'amélioration continue du catalogue cartographique repose sur vos besoins. Vos commentaires et suggestions d'amélioration sont donc très importants pour nous. Cliquez ci-dessous pour accéder à notre formulaire de commentaires.<br><br>" +
