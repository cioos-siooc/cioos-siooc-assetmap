...
function updateHeaderLanguage(newLanguage)
{
    ...
    if ( newLanguage === "en" )
    {
        document.getElementById("headerImg").href = "//cioospacific.ca";
        document.getElementById("headerimgsrc").src = "images/cioos-pacific_logo_RA_EN.png";
    ...
    {
        document.getElementById("headerImg").href = "//cioospacific.ca/fr/";
        document.getElementById("headerimgsrc").src = "images/cioos-pacific_logo_RA_FR.png";
